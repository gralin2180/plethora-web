...
export function SelectModelMenu({
  ...
  /** Chat docks above the composer; tools drop below the header. */
  anchor?: "up" | "down";
}) {
  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      {open && (
        <div className={`absolute z-50 w-[min(100vw-2rem,20rem)] overflow-hidden rounded-xl border border-white/10 bg-[#16161c] shadow-2xl shadow-black/50 ${
