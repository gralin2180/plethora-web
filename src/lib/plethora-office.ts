...
export const OFFICE_APPS: OfficeApp[] = [
  {
    ...
    name: "Word",
    like: "Microsoft Word",
    tagline: "Rich editor, templates, AI teammate Quill. Export HTML — not Word.",
    desk: "docs",
    href: "/office/word",
    icon: "FileText",
    native: true,
  ...
  },
  {
    ...
    name: "Slack",
    like: "Slack",
    tagline: "Team chat, @mentions, AI teammate, Taskbot sync. Free / BYOK / tokens.",
    desk: "collab",
    href: "/office/slack",
    icon: "MessageSquare",
    native: true,
  },
  {
    id: "taskbot",
    name: "Taskbot",
    like: "AI task capture",
    tagline: "Auto-capture tasks, notes, screenshots, and @you mentions from Slack.",
    desk: "collab",
    href: "/office/taskbot",
    icon: "Bot",
    native: true,
...
export const OFFICE_INDUSTRIES: OfficeIndustry[] = [
  {
    ...
    appIds: ["slack", "taskbot", "rooms", "boards", "word", "sheets", "flow", "connect", "infra"],
    extraHrefs: [
