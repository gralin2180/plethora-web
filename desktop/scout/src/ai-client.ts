const SETTINGS_KEY = "plethora.scout.ai.v1";
...
export async function runAi(message: string, system: string, settings: AiSettings): Promise<string> {
  ...
  return data.code || "No AI reply — add BYOK in Settings or sign in on Plethora web.";
}

export const SCOUT_SYSTEM = `You are Scout for Plethora Office (not Slack). Extract actionable items from team chat.
